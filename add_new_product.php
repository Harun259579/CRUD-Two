...
if(isset($_POST['btnsave']))
{
	...
	if(empty($errmsg))
	{
		$stmt =$db_con->prepare("INSERT INTO products(product_name,description,product_image,unit_price,selling_price,stock_amount,has_attributes,category_id)VALUES(:pname,:pdesc,:pimage,:uprice,:sprice,:pstock,:hasattr,:cat_id)"); //:pname agula parametter
		...
		$stmt->bindParam('sprice',$sell_price);
	...
	<div class="container mt-5">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="number" name="uprice" class="form-control" required>
			</div>
			<div class="form-group">
				<label>Selling Price:</label>
				<input type="number" name="sprice" class="form-control" required>
			</div>
...
colorList.innerHTML = '';
selectedColor.forEach((color,indext)=>{
...
colorBox.onclick=()=>
{
selectedColors.splice(indext,1);
updateColorList();
}
